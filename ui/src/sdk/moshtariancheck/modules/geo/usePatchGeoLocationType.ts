...
export function usePatchGeoLocationType({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchGeoLocationType(entity);

  const mutation = useMutation<
    IResponse<geo.GeoLocationTypeEntity>,
    IResponse<geo.GeoLocationTypeEntity>,
    Partial<geo.GeoLocationTypeEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<geo.GeoLocationTypeEntity>,
    formikProps?: FormikHelpers<Partial<geo.GeoLocationTypeEntity>>

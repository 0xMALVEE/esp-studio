...
export function usePatchAcCheckStatusHistorys({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchAcCheckStatusHistorys(entity);

  const mutation = useMutation<
    IResponse<core.BulkRecordRequest<accounting.AcCheckStatusHistoryEntity>>,
    IResponse<core.BulkRecordRequest<accounting.AcCheckStatusHistoryEntity>>,
    Partial<core.BulkRecordRequest<accounting.AcCheckStatusHistoryEntity>>
  >(fn);

...
export function usePatchTransactionTypes({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchTransactionTypes(entity);

  const mutation = useMutation<
    IResponse<core.BulkRecordRequest<accounting.TransactionTypeEntity>>,
    IResponse<core.BulkRecordRequest<accounting.TransactionTypeEntity>>,
    Partial<core.BulkRecordRequest<accounting.TransactionTypeEntity>>
  >(fn);
  ...
  const submit = (
    values: Partial<core.BulkRecordRequest<accounting.TransactionTypeEntity>>,

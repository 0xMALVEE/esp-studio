...
export function useGetPriceTagsExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/price-tags/export".substr(1);
  ...
  const query$ = useQuery(["*currency.PriceTagEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetPriceTagsExport.UKEY = "*currency.PriceTagEntity"
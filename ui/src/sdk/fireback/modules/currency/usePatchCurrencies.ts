...
export function usePatchCurrencies({queryClient, query, execFnOverride}: {queryClient: QueryClient, query?: any, execFnOverride?: any}) {
  query = query || {}
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<CurrencyEntity>) {
          queryClient.setQueriesData("*workspaces.BulkRecordRequest[currency.CurrencyEntity]", (data) =>

...
export function useGetCurrenciesExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/currencies/export".substr(1);
  ...
  const query$ = useQuery(["*currency.CurrencyEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetCurrenciesExport.UKEY = "*currency.CurrencyEntity"
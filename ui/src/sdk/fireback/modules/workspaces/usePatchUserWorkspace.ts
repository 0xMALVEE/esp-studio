...
export function usePatchUserWorkspace({queryClient, query, execFnOverride}: {queryClient: QueryClient, query?: any, execFnOverride?: any}) {
  query = query || {}
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<UserWorkspaceEntity>) {
          queryClient.setQueriesData("*workspaces.UserWorkspaceEntity", (data) =>

...
export function useGetAppMenusExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/app-menus/export".substr(1);
  ...
  const query$ = useQuery(["*workspaces.AppMenuEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetAppMenusExport.UKEY = "*workspaces.AppMenuEntity"
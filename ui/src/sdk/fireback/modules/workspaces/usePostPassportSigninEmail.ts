...
} from "../workspaces/EmailAccountSigninDto"
import {
    UserSessionDto,
} from "../workspaces/UserSessionDto"
export function usePostPassportSigninEmail({queryClient, query, execFnOverride}: UseRemoteQuery) {
  query = query || {}
  ...
  const url = "/passport/signin/email".substr(1);

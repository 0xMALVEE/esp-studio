...
export function usePatchWorkspaceInvite({queryClient, query, execFnOverride}: {queryClient: QueryClient, query?: any, execFnOverride?: any}) {
  query = query || {}
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<WorkspaceInviteEntity>) {
          queryClient.setQueriesData("*workspaces.WorkspaceInviteEntity", (data) =>

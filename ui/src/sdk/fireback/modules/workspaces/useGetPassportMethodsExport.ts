...
export function useGetPassportMethodsExport({
  ...
  const url = "/passport-methods/export".substr(1);
  ...
  const query$ = useQuery(["*workspaces.PassportMethodEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetPassportMethodsExport.UKEY = "*workspaces.PassportMethodEntity"
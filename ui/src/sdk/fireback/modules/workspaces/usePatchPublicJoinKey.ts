...
export function usePatchPublicJoinKey({queryClient, query, execFnOverride}: {queryClient: QueryClient, query?: any, execFnOverride?: any}) {
  query = query || {}
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<PublicJoinKeyEntity>) {
          queryClient.setQueriesData("*workspaces.PublicJoinKeyEntity", (data) =>

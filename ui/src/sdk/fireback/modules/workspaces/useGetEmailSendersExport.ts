...
export function useGetEmailSendersExport({
  ...
  const url = "/email-senders/export".substr(1);
  ...
  const query$ = useQuery(["*workspaces.EmailSenderEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetEmailSendersExport.UKEY = "*workspaces.EmailSenderEntity"
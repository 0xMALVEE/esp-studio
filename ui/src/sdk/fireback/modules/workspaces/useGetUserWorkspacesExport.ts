...
export function useGetUserWorkspacesExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/user-workspaces/export".substr(1);
  ...
  const query$ = useQuery(["*workspaces.UserWorkspaceEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetUserWorkspacesExport.UKEY = "*workspaces.UserWorkspaceEntity"
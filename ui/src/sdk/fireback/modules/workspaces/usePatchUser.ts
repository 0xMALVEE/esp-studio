...
export function usePatchUser({queryClient, query, execFnOverride}: {queryClient: QueryClient, query?: any, execFnOverride?: any}) {
  query = query || {}
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<UserEntity>) {
          queryClient.setQueriesData("*workspaces.UserEntity", (data) =>

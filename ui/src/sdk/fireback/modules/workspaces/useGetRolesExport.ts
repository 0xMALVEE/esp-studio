...
export function useGetRolesExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/roles/export".substr(1);
  ...
  const query$ = useQuery(["*workspaces.RoleEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetRolesExport.UKEY = "*workspaces.RoleEntity"
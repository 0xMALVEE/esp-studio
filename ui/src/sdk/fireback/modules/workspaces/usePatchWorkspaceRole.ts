...
export function usePatchWorkspaceRole({queryClient, query, execFnOverride}: {queryClient: QueryClient, query?: any, execFnOverride?: any}) {
  query = query || {}
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<WorkspaceRoleEntity>) {
          queryClient.setQueriesData("*workspaces.WorkspaceRoleEntity", (data) =>

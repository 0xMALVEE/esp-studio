...
export function useGetPublicWorkspaceTypes({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/publicWorkspaceTypes".substr(1);
  ...
  const query$ = useQuery(["*workspaces.WorkspaceTypeEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetPublicWorkspaceTypes.UKEY = "*workspaces.WorkspaceTypeEntity"
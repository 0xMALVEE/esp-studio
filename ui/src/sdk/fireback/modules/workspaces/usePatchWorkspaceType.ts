...
export function usePatchWorkspaceType({queryClient, query, execFnOverride}: {queryClient: QueryClient, query?: any, execFnOverride?: any}) {
  query = query || {}
  ...
  const url = "/workspace-type".substr(1);

...
export function useGetWorkspaceRolesExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/workspace-roles/export".substr(1);
  ...
  const query$ = useQuery(["*workspaces.WorkspaceRoleEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,

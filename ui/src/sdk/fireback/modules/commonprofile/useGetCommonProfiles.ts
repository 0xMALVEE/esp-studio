...
export function useGetCommonProfiles({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const query$ = useQuery(["*commonprofile.CommonProfileEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetCommonProfiles.UKEY = "*commonprofile.CommonProfileEntity"
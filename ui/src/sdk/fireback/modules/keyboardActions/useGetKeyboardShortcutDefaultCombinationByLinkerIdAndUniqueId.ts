...
export function useGetKeyboardShortcutDefaultCombinationByLinkerIdAndUniqueId({ 
    queryOptions,
    execFnOverride,
    query,
    queryClient,
  ...
  const url = "/keyboard-shortcut/default_combination/:linkerId/:uniqueId".substr(1);
  ...
  const query$ = useQuery([options, query, "*keyboardActions.KeyboardShortcutDefaultCombination"], fn, {
    cacheTime: 1001,
    retry: false,

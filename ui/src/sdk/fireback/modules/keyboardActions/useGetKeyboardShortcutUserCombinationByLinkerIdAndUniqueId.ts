...
export function useGetKeyboardShortcutUserCombinationByLinkerIdAndUniqueId({ 
    queryOptions,
    execFnOverride,
    query,
    queryClient,
  ...
  const url = "/keyboard-shortcut/user_combination/:linkerId/:uniqueId".substr(1);
  ...
  const query$ = useQuery([options, query, "*keyboardActions.KeyboardShortcutUserCombination"], fn, {
    cacheTime: 1001,
    retry: false,

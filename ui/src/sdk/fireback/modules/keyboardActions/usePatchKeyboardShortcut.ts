...
export function usePatchKeyboardShortcut({queryClient, query, execFnOverride}: {queryClient: QueryClient, query?: any, execFnOverride?: any}) {
  query = query || {}
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<KeyboardShortcutEntity>) {
          queryClient.setQueriesData("*keyboardActions.KeyboardShortcutEntity", (data) =>

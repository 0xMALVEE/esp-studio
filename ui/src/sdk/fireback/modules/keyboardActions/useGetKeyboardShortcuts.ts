...
export function useGetKeyboardShortcuts({
  ...
  const query$ = useQuery(["*keyboardActions.KeyboardShortcutEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetKeyboardShortcuts.UKEY = "*keyboardActions.KeyboardShortcutEntity"
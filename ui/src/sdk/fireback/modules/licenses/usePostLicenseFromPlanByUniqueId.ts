...
export function usePostLicenseFromPlanByUniqueId({queryClient, query, execFnOverride}: UseRemoteQuery) {
  query = query || {}
  ...
  const url = "/license/from-plan/:uniqueId".substr(1);
  ...
  const submit = (
    values: Partial<LicenseFromPlanIdDto>,

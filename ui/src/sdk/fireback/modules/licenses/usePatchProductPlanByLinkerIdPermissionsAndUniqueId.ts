...
export function usePatchProductPlanByLinkerIdPermissionsAndUniqueId({queryClient, query, execFnOverride}: {queryClient: QueryClient, query?: any, execFnOverride?: any}) {
  query = query || {}
  ...
  const url = "/product-plan/:linkerId/permissions/:uniqueId".substr(1);
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<ProductPlanPermissions>) {
          queryClient.setQueriesData("*licenses.ProductPlanPermissions", (data) =>

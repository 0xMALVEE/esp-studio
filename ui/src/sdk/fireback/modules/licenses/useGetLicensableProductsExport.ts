...
export function useGetLicensableProductsExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/licensable-products/export".substr(1);
  ...
  const query$ = useQuery(["*licenses.LicensableProductEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetLicensableProductsExport.UKEY = "*licenses.LicensableProductEntity"
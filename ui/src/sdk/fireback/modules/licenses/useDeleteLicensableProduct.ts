...
export function useDeleteLicensableProduct({execFnOverride, queryClient, query}: {queryClient: QueryClient, execFnOverride?: any, query?: any}) {
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IDeleteResponse) {
          ...
          queryClient.invalidateQueries("*licenses.LicensableProductEntity");
          resolve(response);
        },
        onError(error: any) {

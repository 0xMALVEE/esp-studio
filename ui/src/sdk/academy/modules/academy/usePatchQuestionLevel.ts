...
export function usePatchQuestionLevel({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchQuestionLevel(entity);

  const mutation = useMutation<
    IResponse<academy.QuestionLevelEntity>,
    IResponse<academy.QuestionLevelEntity>,
    Partial<academy.QuestionLevelEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<academy.QuestionLevelEntity>,
    formikProps?: FormikHelpers<Partial<academy.QuestionLevelEntity>>

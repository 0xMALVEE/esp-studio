...
export function usePatchExamSessionReviews({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchExamSessionReviews(entity);

  const mutation = useMutation<
    IResponse<core.BulkRecordRequest<academy.ExamSessionReviewEntity>>,
    IResponse<core.BulkRecordRequest<academy.ExamSessionReviewEntity>>,
    Partial<core.BulkRecordRequest<academy.ExamSessionReviewEntity>>
  >(fn);
  ...
  const submit = (
    values: Partial<core.BulkRecordRequest<academy.ExamSessionReviewEntity>>,

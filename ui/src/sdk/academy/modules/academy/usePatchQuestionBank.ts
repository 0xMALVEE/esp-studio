...
export function usePatchQuestionBank({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchQuestionBank(entity);

  const mutation = useMutation<
    IResponse<academy.QuestionBankEntity>,
    IResponse<academy.QuestionBankEntity>,
    Partial<academy.QuestionBankEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<academy.QuestionBankEntity>,
    formikProps?: FormikHelpers<Partial<academy.QuestionBankEntity>>

...
export function useGetQuestionDifficulityLevelByUniqueId({
  queryOptions,
  execFnOverride,
  query,
  queryClient,
  ...
  const fn = () => Q().getQuestionDifficulityLevelByUniqueId(query.uniqueId);
  ...
  const query$ = useQuery(
    [options, query, "getQuestionDifficulityLevelByUniqueId"],
    fn,
    {
      cacheTime: 1001,
      retry: false,

...
export function usePatchCourseEnrollments({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchCourseEnrollments(entity);

  const mutation = useMutation<
    IResponse<core.BulkRecordRequest<academy.CourseEnrollmentEntity>>,
    IResponse<core.BulkRecordRequest<academy.CourseEnrollmentEntity>>,
    Partial<core.BulkRecordRequest<academy.CourseEnrollmentEntity>>
  >(fn);
  ...
  const submit = (
    values: Partial<core.BulkRecordRequest<academy.CourseEnrollmentEntity>>,

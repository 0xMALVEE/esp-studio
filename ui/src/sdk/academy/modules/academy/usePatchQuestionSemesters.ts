...
export function usePatchQuestionSemesters({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchQuestionSemesters(entity);

  const mutation = useMutation<
    IResponse<core.BulkRecordRequest<academy.QuestionSemesterEntity>>,
    IResponse<core.BulkRecordRequest<academy.QuestionSemesterEntity>>,
    Partial<core.BulkRecordRequest<academy.QuestionSemesterEntity>>
  >(fn);
  ...
  const submit = (
    values: Partial<core.BulkRecordRequest<academy.QuestionSemesterEntity>>,

...
export function usePostUnit({
  ...
  const fn = (entity: any) => Q().postUnit(entity);

  const mutation = useMutation<
    IResponse<academy.UnitEntity>,
    IResponse<academy.UnitEntity>,
    Partial<academy.UnitEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<academy.UnitEntity>,
    formikProps?: FormikHelpers<Partial<academy.UnitEntity>>

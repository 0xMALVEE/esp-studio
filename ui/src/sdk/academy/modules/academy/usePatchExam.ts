...
export function usePatchExam({
  ...
  const fn = (entity: any) => Q().patchExam(entity);

  const mutation = useMutation<
    IResponse<academy.ExamEntity>,
    IResponse<academy.ExamEntity>,
    Partial<academy.ExamEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<academy.ExamEntity>,
    formikProps?: FormikHelpers<Partial<academy.ExamEntity>>

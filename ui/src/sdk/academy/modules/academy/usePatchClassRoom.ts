...
export function usePatchClassRoom({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchClassRoom(entity);

  const mutation = useMutation<
    IResponse<academy.ClassRoomEntity>,
    IResponse<academy.ClassRoomEntity>,
    Partial<academy.ClassRoomEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<academy.ClassRoomEntity>,
    formikProps?: FormikHelpers<Partial<academy.ClassRoomEntity>>

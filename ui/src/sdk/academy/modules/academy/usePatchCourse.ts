...
export function usePatchCourse({
  ...
  const fn = (entity: any) => Q().patchCourse(entity);

  const mutation = useMutation<
    IResponse<academy.CourseEntity>,
    IResponse<academy.CourseEntity>,
    Partial<academy.CourseEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<academy.CourseEntity>,
    formikProps?: FormikHelpers<Partial<academy.CourseEntity>>

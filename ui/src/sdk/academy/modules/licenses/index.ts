...
export const ActivationKeyEntity = {
  encode(
    ...
    if (message.series !== undefined) {
      writer.uint32(66).string(message.series);
    }
    if (message.used !== undefined) {
      writer.uint32(72).int64(message.used);
    }
    if (message.planId !== undefined) {
      writer.uint32(90).string(message.planId);
    }
    if (message.plan !== undefined) {
      ProductPlanEntity.encode(message.plan, writer.uint32(98).fork()).ldelim();
    }
    if (message.rank !== 0) {
...
export const LicensableProductEntity = {
  encode(
    ...
    if (message.privateKey !== undefined) {
      writer.uint32(82).string(message.privateKey);
    }
    if (message.publicKey !== undefined) {
      writer.uint32(90).string(message.publicKey);
    }
    if (message.rank !== 0) {
...
export const LicenseEntity = {
  encode(
    ...
    if (message.signedLicense !== undefined) {
      writer.uint32(74).string(message.signedLicense);
    }
    ...
    for (const v of message.permissions) {
      LicensePermissionEntity.encode(v!, writer.uint32(98).fork()).ldelim();
    }
    if (message.rank !== 0) {
      writer.uint32(104).int64(message.rank);
    }
...
export const LicensePermissionEntity = {
  encode(
    ...
    if (message.capabilityId !== undefined) {
      writer.uint32(74).string(message.capabilityId);
    }
...
export const ProductPlanEntity = {
  encode(
    ...
    for (const v of message.translations) {
      ProductPlanEntityPolyglot.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    if (message.name !== undefined) {
      writer.uint32(74).string(message.name);
    }
    ...
    if (message.priceTagId !== undefined) {
      writer.uint32(122).string(message.priceTagId);
    }

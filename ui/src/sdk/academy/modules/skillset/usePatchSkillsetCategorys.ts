...
export function usePatchSkillsetCategorys({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchSkillsetCategorys(entity);

  const mutation = useMutation<
    IResponse<core.BulkRecordRequest<skillset.SkillsetCategoryEntity>>,
    IResponse<core.BulkRecordRequest<skillset.SkillsetCategoryEntity>>,
    Partial<core.BulkRecordRequest<skillset.SkillsetCategoryEntity>>
  >(fn);
  ...
  const submit = (
    values: Partial<core.BulkRecordRequest<skillset.SkillsetCategoryEntity>>,

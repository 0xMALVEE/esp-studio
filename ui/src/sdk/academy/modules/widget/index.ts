...
export const WidgetAreaEntity = {
  encode(
    ...
    for (const v of message.translations) {
      WidgetAreaEntityPolyglot.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    if (message.name !== undefined) {
      writer.uint32(74).string(message.name);
    }
    if (message.layouts !== undefined) {
      writer.uint32(82).string(message.layouts);
    }
    for (const v of message.widgets) {
      WidgetAreaWidgetsEntity.encode(v!, writer.uint32(90).fork()).ldelim();
    }
    if (message.rank !== 0) {
...
export const WidgetAreaWidgetsEntity = {
  encode(
    ...
    if (message.widgetId !== undefined) {
      writer.uint32(90).string(message.widgetId);
    }
    if (message.widget !== undefined) {
      WidgetEntity.encode(message.widget, writer.uint32(98).fork()).ldelim();
    }
    if (message.x !== undefined) {
      writer.uint32(104).int64(message.x);
    }
    if (message.y !== undefined) {
      writer.uint32(112).int64(message.y);
    }
    if (message.w !== undefined) {
      writer.uint32(120).int64(message.w);
    }
    if (message.h !== undefined) {
      writer.uint32(128).int64(message.h);
    }
    if (message.data !== undefined) {
      writer.uint32(138).string(message.data);
    }
    if (message.rank !== 0) {
...
export const WidgetEntity = {
  encode(
    ...
    for (const v of message.translations) {
      WidgetEntityPolyglot.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    if (message.name !== undefined) {
      writer.uint32(74).string(message.name);
    }
    ...
    if (message.providerKey !== undefined) {
      writer.uint32(90).string(message.providerKey);
    }
    if (message.rank !== 0) {
      writer.uint32(96).int64(message.rank);
    }

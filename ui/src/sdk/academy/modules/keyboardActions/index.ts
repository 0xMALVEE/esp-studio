...
export const KeyboardShortcutEntity = {
  encode(
    ...
    if (message.action !== undefined) {
      writer.uint32(106).string(message.action);
    }
    if (message.actionKey !== undefined) {
      writer.uint32(114).string(message.actionKey);
    }
    if (message.rank !== 0) {
...
export const KeyboardShortcutDefaultCombinationEntity = {
  encode(
    ...
    if (message.altKey !== undefined) {
      writer.uint32(64).bool(message.altKey);
    }
    if (message.key !== undefined) {
      writer.uint32(74).string(message.key);
    }
    if (message.metaKey !== undefined) {
      writer.uint32(80).bool(message.metaKey);
    }
    if (message.shiftKey !== undefined) {
      writer.uint32(88).bool(message.shiftKey);
    }
    if (message.ctrlKey !== undefined) {
      writer.uint32(96).bool(message.ctrlKey);
    }
    if (message.rank !== 0) {

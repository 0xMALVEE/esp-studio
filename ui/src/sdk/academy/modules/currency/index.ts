...
export const CurrencyEntity = {
  encode(
    ...
    for (const v of message.translations) {
      CurrencyEntityPolyglot.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    ...
    if (message.symbolNative !== undefined) {
      writer.uint32(90).string(message.symbolNative);
    }
    if (message.decimalDigits !== undefined) {
      writer.uint32(96).int64(message.decimalDigits);
    }
    if (message.rounding !== undefined) {
      writer.uint32(104).int64(message.rounding);
    }
    if (message.code !== undefined) {
      writer.uint32(114).string(message.code);
    }
    if (message.namePlural !== undefined) {
      writer.uint32(122).string(message.namePlural);
    }
    if (message.rank !== 0) {
...
export const PriceTagEntity = {
  encode(
    ...
    for (const v of message.variations) {
      PriceTagVariationEntity.encode(v!, writer.uint32(66).fork()).ldelim();
    }
    if (message.rank !== 0) {

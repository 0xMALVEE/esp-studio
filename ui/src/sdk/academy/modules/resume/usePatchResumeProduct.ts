...
export function usePatchResumeProduct({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchResumeProduct(entity);

  const mutation = useMutation<
    IResponse<resume.ResumeProductEntity>,
    IResponse<resume.ResumeProductEntity>,
    Partial<resume.ResumeProductEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<resume.ResumeProductEntity>,
    formikProps?: FormikHelpers<Partial<resume.ResumeProductEntity>>

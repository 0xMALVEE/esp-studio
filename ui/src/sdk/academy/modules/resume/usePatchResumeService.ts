...
export function usePatchResumeService({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchResumeService(entity);

  const mutation = useMutation<
    IResponse<resume.ResumeServiceEntity>,
    IResponse<resume.ResumeServiceEntity>,
    Partial<resume.ResumeServiceEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<resume.ResumeServiceEntity>,
    formikProps?: FormikHelpers<Partial<resume.ResumeServiceEntity>>

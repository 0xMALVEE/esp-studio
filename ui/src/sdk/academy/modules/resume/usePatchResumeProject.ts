...
export function usePatchResumeProject({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchResumeProject(entity);

  const mutation = useMutation<
    IResponse<resume.ResumeProjectEntity>,
    IResponse<resume.ResumeProjectEntity>,
    Partial<resume.ResumeProjectEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<resume.ResumeProjectEntity>,
    formikProps?: FormikHelpers<Partial<resume.ResumeProjectEntity>>

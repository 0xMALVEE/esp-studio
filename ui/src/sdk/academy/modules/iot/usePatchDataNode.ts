...
export function usePatchDataNode({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchDataNode(entity);

  const mutation = useMutation<
    IResponse<iot.DataNodeEntity>,
    IResponse<iot.DataNodeEntity>,
    Partial<iot.DataNodeEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<iot.DataNodeEntity>,
    formikProps?: FormikHelpers<Partial<iot.DataNodeEntity>>

...
export function usePatchModbusFunctionCodes({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchModbusFunctionCodes(entity);

  const mutation = useMutation<
    IResponse<core.BulkRecordRequest<iot.ModbusFunctionCodeEntity>>,
    IResponse<core.BulkRecordRequest<iot.ModbusFunctionCodeEntity>>,
    Partial<core.BulkRecordRequest<iot.ModbusFunctionCodeEntity>>
  >(fn);
  ...
  const submit = (
    values: Partial<core.BulkRecordRequest<iot.ModbusFunctionCodeEntity>>,

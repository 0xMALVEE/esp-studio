...
export function usePatchDeviceType({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchDeviceType(entity);

  const mutation = useMutation<
    IResponse<iot.DeviceTypeEntity>,
    IResponse<iot.DeviceTypeEntity>,
    Partial<iot.DeviceTypeEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<iot.DeviceTypeEntity>,
    formikProps?: FormikHelpers<Partial<iot.DeviceTypeEntity>>

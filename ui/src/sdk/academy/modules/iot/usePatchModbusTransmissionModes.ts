...
export function usePatchModbusTransmissionModes({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchModbusTransmissionModes(entity);

  const mutation = useMutation<
    IResponse<core.BulkRecordRequest<iot.ModbusTransmissionModeEntity>>,
    IResponse<core.BulkRecordRequest<iot.ModbusTransmissionModeEntity>>,
    Partial<core.BulkRecordRequest<iot.ModbusTransmissionModeEntity>>
  >(fn);
  ...
  const submit = (
    values: Partial<core.BulkRecordRequest<iot.ModbusTransmissionModeEntity>>,

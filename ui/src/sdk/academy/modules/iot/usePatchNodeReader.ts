...
export function usePatchNodeReader({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchNodeReader(entity);

  const mutation = useMutation<
    IResponse<iot.NodeReaderEntity>,
    IResponse<iot.NodeReaderEntity>,
    Partial<iot.NodeReaderEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<iot.NodeReaderEntity>,
    formikProps?: FormikHelpers<Partial<iot.NodeReaderEntity>>

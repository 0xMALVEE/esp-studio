...
export function usePatchPhysicalSection({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchPhysicalSection(entity);

  const mutation = useMutation<
    IResponse<iot.PhysicalSectionEntity>,
    IResponse<iot.PhysicalSectionEntity>,
    Partial<iot.PhysicalSectionEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<iot.PhysicalSectionEntity>,
    formikProps?: FormikHelpers<Partial<iot.PhysicalSectionEntity>>

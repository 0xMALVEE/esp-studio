...
export const CommonProfileEntity = {
  encode(
    ...
    if (message.company !== undefined) {
      writer.uint32(98).string(message.company);
    }
    if (message.street !== undefined) {
      writer.uint32(106).string(message.street);
    }
    if (message.houseNumber !== undefined) {
      writer.uint32(114).string(message.houseNumber);
    }
    if (message.zipCode !== undefined) {
      writer.uint32(122).string(message.zipCode);
    }

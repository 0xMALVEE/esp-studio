...
export const GeoCityEntity = {
  encode(
    ...
    if (message.stateId !== undefined) {
      writer.uint32(106).string(message.stateId);
    }
    if (message.state !== undefined) {
      GeoStateEntity.encode(message.state, writer.uint32(114).fork()).ldelim();
    }
    if (message.countryId !== undefined) {
      writer.uint32(130).string(message.countryId);
    }
...
export const GeoCountryEntity = {
  encode(
    ...
    for (const v of message.translations) {
      GeoCountryEntityPolyglot.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    if (message.status !== undefined) {
      writer.uint32(74).string(message.status);
    }
    if (message.flag !== undefined) {
      writer.uint32(82).string(message.flag);
    }
    if (message.commonName !== undefined) {
      writer.uint32(90).string(message.commonName);
    }
    if (message.officialName !== undefined) {
      writer.uint32(98).string(message.officialName);
    }
    if (message.rank !== 0) {
...
export const GeoProvinceEntity = {
  encode(
    ...
    for (const v of message.translations) {
      GeoProvinceEntityPolyglot.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    if (message.name !== undefined) {
      writer.uint32(74).string(message.name);
    }
    if (message.countryId !== undefined) {
      writer.uint32(90).string(message.countryId);
    }
    if (message.country !== undefined) {
      GeoCountryEntity.encode(
        message.country,
...
export const GeoStateEntity = {
  encode(
    ...
    for (const v of message.translations) {
      GeoStateEntityPolyglot.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    if (message.name !== undefined) {
      writer.uint32(74).string(message.name);
    }
...
export const LocationDataEntity = {
  encode(
    ...
    if (message.physicalAddress !== undefined) {
      writer.uint32(82).string(message.physicalAddress);
    }
    if (message.rank !== 0) {

...
export function usePatchGeoCity({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchGeoCity(entity);

  const mutation = useMutation<
    IResponse<geo.GeoCityEntity>,
    IResponse<geo.GeoCityEntity>,
    Partial<geo.GeoCityEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<geo.GeoCityEntity>,
    formikProps?: FormikHelpers<Partial<geo.GeoCityEntity>>

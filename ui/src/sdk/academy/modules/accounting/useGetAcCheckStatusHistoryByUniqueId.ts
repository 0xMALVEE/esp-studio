...
export function useGetAcCheckStatusHistoryByUniqueId({
  queryOptions,
  execFnOverride,
  query,
  queryClient,
  ...
  const fn = () => Q().getAcCheckStatusHistoryByUniqueId(query.uniqueId);
  ...
  const query$ = useQuery(
    [options, query, "getAcCheckStatusHistoryByUniqueId"],
    fn,
    {
      cacheTime: 1001,
      retry: false,

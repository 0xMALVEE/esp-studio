...
export function usePatchAcCheckStatus({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchAcCheckStatus(entity);

  const mutation = useMutation<
    IResponse<accounting.AcCheckStatusEntity>,
    IResponse<accounting.AcCheckStatusEntity>,
    Partial<accounting.AcCheckStatusEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<accounting.AcCheckStatusEntity>,
    formikProps?: FormikHelpers<Partial<accounting.AcCheckStatusEntity>>

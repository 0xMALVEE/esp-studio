...
export function usePatchAcBank({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchAcBank(entity);

  const mutation = useMutation<
    IResponse<accounting.AcBankEntity>,
    IResponse<accounting.AcBankEntity>,
    Partial<accounting.AcBankEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<accounting.AcBankEntity>,
    formikProps?: FormikHelpers<Partial<accounting.AcBankEntity>>

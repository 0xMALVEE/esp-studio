...
import { GeoCityEntity, GeoProvinceEntity } from "../geo/index";
...
export interface AcBankBranchEntity {
  ...
  /** @tag(gorm:"foreignKey:CityId;references:UniqueId" json:"city" yaml:"city" fbtype:"one") */
  city: GeoCityEntity | undefined;
...
export const AcBankBranchEntity = {
  encode(
    ...
    for (const v of message.translations) {
      AcBankBranchEntityPolyglot.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    if (message.provinceId !== undefined) {
      writer.uint32(82).string(message.provinceId);
    }
    ...
    if (message.cityId !== undefined) {
      writer.uint32(106).string(message.cityId);
    }
    if (message.city !== undefined) {
      GeoCityEntity.encode(message.city, writer.uint32(114).fork()).ldelim();
    }
    if (message.name !== undefined) {
      writer.uint32(122).string(message.name);
    }
    if (message.bankId !== undefined) {
      writer.uint32(138).string(message.bankId);
    }
    if (message.bank !== undefined) {
      AcBankEntity.encode(message.bank, writer.uint32(146).fork()).ldelim();
    }
    if (message.rank !== 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13:
          ...
          break;
        case 14:
          message.city = GeoCityEntity.decode(reader, reader.uint32());
          break;
        case 15:
  ...
  fromJSON(object: any): AcBankBranchEntity {
    return {
      ...
      province: isSet(object.province)
        ...
        : undefined,
      cityId: isSet(object.cityId) ? String(object.cityId) : undefined,
      city: isSet(object.city)
        ? GeoCityEntity.fromJSON(object.city)
        : undefined,
  ...
  toJSON(message: AcBankBranchEntity): unknown {
    ...
    message.province !== undefined &&
      (obj.province = message.province
        ...
        : undefined);
    message.cityId !== undefined && (obj.cityId = message.cityId);
    message.city !== undefined &&
      (obj.city = message.city
        ? GeoCityEntity.toJSON(message.city)
        : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<AcBankBranchEntity>, I>>(
    ...
    message.province =
      object.province !== undefined && object.province !== null
        ...
        : undefined;
    message.cityId = object.cityId ?? undefined;
    message.city =
      object.city !== undefined && object.city !== null
        ? GeoCityEntity.fromPartial(object.city)
        : undefined;
...
export const AcBankEntity = {
  encode(
    ...
    for (const v of message.translations) {
      AcBankEntityPolyglot.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    if (message.name !== undefined) {
...
export const AcCheckEntity = {
  encode(
    ...
    if (message.dueDate !== 0) {
      writer.uint32(96).int64(message.dueDate);
    }
    if (message.dueDateFormatted !== "") {
      writer.uint32(106).string(message.dueDateFormatted);
    }
    if (message.issueDate !== 0) {
      writer.uint32(120).int64(message.issueDate);
    }
    if (message.issueDateFormatted !== "") {
      writer.uint32(130).string(message.issueDateFormatted);
    }
    if (message.bankBranchId !== undefined) {
      writer.uint32(146).string(message.bankBranchId);
    }
    ...
    if (message.recipientBankBranchId !== undefined) {
      writer.uint32(170).string(message.recipientBankBranchId);
    }
    ...
    if (message.recipientCustomerId !== undefined) {
      writer.uint32(194).string(message.recipientCustomerId);
    }
    ...
    if (message.amount !== undefined) {
      writer.uint32(209).double(message.amount);
    }
    if (message.amountFormatted !== "") {
      writer.uint32(226).string(message.amountFormatted);
    }
    if (message.identifier !== undefined) {
      writer.uint32(234).string(message.identifier);
    }
    if (message.currencyId !== undefined) {
      writer.uint32(250).string(message.currencyId);
    }
    if (message.currency !== undefined) {
    ...
    if (message.statusId !== undefined) {
      writer.uint32(274).string(message.statusId);
    }
...
export const AcCheckStatusEntity = {
  encode(
    ...
    for (const v of message.translations) {
      AcCheckStatusEntityPolyglot.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    if (message.name !== undefined) {
      writer.uint32(74).string(message.name);
    }
...
export const AcCheckStatusHistoryEntity = {
  encode(
    ...
    if (message.fromStateId !== undefined) {
      writer.uint32(90).string(message.fromStateId);
    }
    ...
    if (message.checkId !== undefined) {
      writer.uint32(114).string(message.checkId);
    }
    if (message.check !== undefined) {
      AcCheckEntity.encode(message.check, writer.uint32(122).fork()).ldelim();
    }
    if (message.toStateId !== undefined) {
      writer.uint32(138).string(message.toStateId);
    }
...
export const AcLegalUnitEntity = {
  encode(
    ...
    if (message.legalType !== undefined) {
      writer.uint32(66).string(message.legalType);
    }
    if (message.name !== undefined) {
      writer.uint32(74).string(message.name);
    }
...
export const AcTransactionEntity = {
  encode(
    ...
    if (message.correspondence !== undefined) {
      writer.uint32(122).string(message.correspondence);
    }
    if (message.correspondenceAccount !== undefined) {
      writer.uint32(130).string(message.correspondenceAccount);
    }
    if (message.amount !== undefined) {
      writer.uint32(137).double(message.amount);
    }
    if (message.summary !== undefined) {
      writer.uint32(145).double(message.summary);
    }
    if (message.accountId !== undefined) {
      writer.uint32(162).string(message.accountId);
    }
...
export const IntacodeEntity = {
  encode(
    ...
    if (message.year !== undefined) {
      writer.uint32(80).int64(message.year);
    }
    if (message.margin !== undefined) {
      writer.uint32(89).double(message.margin);
    }
    if (message.rank !== 0) {

...
export function useGetVirtualTransactionByUniqueId({
  queryOptions,
  execFnOverride,
  query,
  queryClient,
  ...
  const fn = () => Q().getVirtualTransactionByUniqueId(query.uniqueId);
  ...
  const query$ = useQuery(
    [options, query, "getVirtualTransactionByUniqueId"],
    fn,
    {
      cacheTime: 1001,
      retry: false,

...
export function useGetShopProductCategoryByUniqueId({
  queryOptions,
  execFnOverride,
  query,
  queryClient,
  ...
  const fn = () => Q().getShopProductCategoryByUniqueId(query.uniqueId);
  ...
  const query$ = useQuery(
    [options, query, "getShopProductCategoryByUniqueId"],
    fn,
    {
      cacheTime: 1001,
      retry: false,

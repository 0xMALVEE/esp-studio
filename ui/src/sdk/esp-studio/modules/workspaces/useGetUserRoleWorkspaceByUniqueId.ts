...
export function useGetUserRoleWorkspaceByUniqueId({ 
    queryOptions,
    execFnOverride,
    query,
    queryClient,
  ...
  const url = "/user-role-workspace/:uniqueId".substr(1);
  ...
  const query$ = useQuery([options, query, "*workspaces.UserRoleWorkspaceEntity"], fn, {
    cacheTime: 1001,
    retry: false,

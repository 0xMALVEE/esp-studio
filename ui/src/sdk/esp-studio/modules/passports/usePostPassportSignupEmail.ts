...
} from "../workspaces/EmailAccountSignupDto"
import {
    UserSessionDto,
} from "../workspaces/UserSessionDto"
export function usePostPassportSignupEmail({queryClient, query, execFnOverride}: UseRemoteQuery) {
  query = query || {}
  ...
  const url = "/passport/signup/email".substr(1);

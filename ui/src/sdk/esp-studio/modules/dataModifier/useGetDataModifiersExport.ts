...
export function useGetDataModifiersExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/dataModifiers/export".substr(1);
  ...
  const query$ = useQuery(["*dataModifier.DataModifierEntity", options, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetDataModifiersExport.UKEY = "*dataModifier.DataModifierEntity"
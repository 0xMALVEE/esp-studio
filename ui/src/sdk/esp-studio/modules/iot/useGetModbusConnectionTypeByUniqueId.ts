...
export function useGetModbusConnectionTypeByUniqueId({ 
    queryOptions,
    execFnOverride,
    query,
    queryClient,
  ...
  const url = "/modbus-connection-type/:uniqueId".substr(1);
  ...
  const query$ = useQuery([options, query, "*iot.ModbusConnectionTypeEntity"], fn, {
    cacheTime: 1001,
    retry: false,

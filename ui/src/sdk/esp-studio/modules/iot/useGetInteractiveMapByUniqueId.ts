...
export function useGetInteractiveMapByUniqueId({ 
    queryOptions,
    execFnOverride,
    query,
    queryClient,
  ...
  const url = "/interactive-map/:uniqueId".substr(1);
  ...
  const query$ = useQuery([options, query, "*iot.InteractiveMapEntity"], fn, {
    cacheTime: 1001,
    retry: false,

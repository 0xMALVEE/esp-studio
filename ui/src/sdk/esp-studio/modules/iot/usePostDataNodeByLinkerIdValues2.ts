...
export function usePostDataNodeByLinkerIdValues2(props?: UseRemoteQuery) {
  ...
  const url = "/dataNode/:linkerId/values2".substr(1);
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<DataNodeValues>) {
          queryClient?.setQueryData<IResponseList<DataNodeValues>>(
            "*iot.DataNodeValues",

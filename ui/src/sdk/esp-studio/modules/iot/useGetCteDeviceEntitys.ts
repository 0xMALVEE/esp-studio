...
export function useGetCteDeviceEntitys({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/cteDeviceEntitys".substr(1);
  ...
  const query$ = useQuery(["*iot.DeviceEntity", options, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetCteDeviceEntitys.UKEY = "*iot.DeviceEntity"
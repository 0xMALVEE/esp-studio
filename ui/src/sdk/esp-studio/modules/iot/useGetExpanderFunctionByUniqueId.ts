...
export function useGetExpanderFunctionByUniqueId({ 
    queryOptions,
    execFnOverride,
    query,
    queryClient,
  ...
  const url = "/expander-function/:uniqueId".substr(1);
  ...
  const query$ = useQuery([options, query, "*iot.ExpanderFunctionEntity"], fn, {
    cacheTime: 1001,
    retry: false,

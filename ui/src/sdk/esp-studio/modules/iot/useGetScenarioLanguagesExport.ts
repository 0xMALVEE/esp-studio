...
export function useGetScenarioLanguagesExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/scenarioLanguages/export".substr(1);
  ...
  const query$ = useQuery(["*iot.ScenarioLanguageEntity", options, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetScenarioLanguagesExport.UKEY = "*iot.ScenarioLanguageEntity"
...
export function useGetComparisonTypesExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/comparisonTypes/export".substr(1);
  ...
  const query$ = useQuery(["*iot.ComparisonTypeEntity", options, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetComparisonTypesExport.UKEY = "*iot.ComparisonTypeEntity"
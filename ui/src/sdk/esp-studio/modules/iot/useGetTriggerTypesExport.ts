...
export function useGetTriggerTypesExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/triggerTypes/export".substr(1);
  ...
  const query$ = useQuery(["*iot.TriggerTypeEntity", options, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetTriggerTypesExport.UKEY = "*iot.TriggerTypeEntity"
...
export function useDeleteScenarioLanguage({execFnOverride, queryClient, query}: {queryClient: QueryClient, execFnOverride?: any, query?: any}) {
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IDeleteResponse) {
          ...
          queryClient.invalidateQueries("*iot.ScenarioLanguageEntity");
          resolve(response);
        },
        onError(error: any) {

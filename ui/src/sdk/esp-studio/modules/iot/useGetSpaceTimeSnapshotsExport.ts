...
export function useGetSpaceTimeSnapshotsExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/space-time-snapshots/export".substr(1);
...
useGetSpaceTimeSnapshotsExport.UKEY = "*iot.SpaceTimeSnapshotEntity"
...
export function useGetMqttConnectionByUniqueId({ 
    queryOptions,
    execFnOverride,
    query,
    queryClient,
  ...
  const url = "/mqtt-connection/:uniqueId".substr(1);
  ...
  const query$ = useQuery([options, query, "*iot.MqttConnectionEntity"], fn, {
    cacheTime: 1001,
    retry: false,

...
export function useGetHmiComponentTypeByUniqueId({ 
    queryOptions,
    execFnOverride,
    query,
    queryClient,
  ...
  const url = "/hmi-component-type/:uniqueId".substr(1);
  ...
  const query$ = useQuery([options, query, "*iot.HmiComponentTypeEntity"], fn, {
    cacheTime: 1001,
    retry: false,

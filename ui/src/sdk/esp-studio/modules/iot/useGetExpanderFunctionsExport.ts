...
export function useGetExpanderFunctionsExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/expander-functions/export".substr(1);
...
useGetExpanderFunctionsExport.UKEY = "*iot.ExpanderFunctionEntity"
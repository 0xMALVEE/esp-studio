...
export function useGetSpaceTimeSnapshotByUniqueId({ 
    queryOptions,
    execFnOverride,
    query,
    queryClient,
  ...
  const url = "/space-time-snapshot/:uniqueId".substr(1);
  ...
  const query$ = useQuery([options, query, "*iot.SpaceTimeSnapshotEntity"], fn, {
    cacheTime: 1001,
    retry: false,

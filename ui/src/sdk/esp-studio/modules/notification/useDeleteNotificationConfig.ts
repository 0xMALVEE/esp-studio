...
export function useDeleteNotificationConfig({execFnOverride, queryClient, query}: {queryClient: QueryClient, execFnOverride?: any, query?: any}) {
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IDeleteResponse) {
          ...
          queryClient.invalidateQueries("*workspaces.NotificationConfigEntity");
          resolve(response);
        },
        onError(error: any) {

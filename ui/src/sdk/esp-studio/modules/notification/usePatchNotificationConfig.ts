...
export function usePatchNotificationConfig({queryClient, query, execFnOverride}: {queryClient: QueryClient, query?: any, execFnOverride?: any}) {
  query = query || {}
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<NotificationConfigEntity>) {
          queryClient.setQueriesData("*workspaces.NotificationConfigEntity", (data) =>

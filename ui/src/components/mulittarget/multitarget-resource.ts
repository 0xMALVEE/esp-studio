...
const icons: IconOsMap = {
  ...
  chart: {
    default: "ios-theme/icons/chart.svg",
  },
  entity: {
  ...
  play: {
    default: "ios-theme/icons/play.svg",
  },
  lock: {
    default: "ios-theme/icons/lock.svg",
  },
  unlock: {
    default: "ios-theme/icons/unlock.svg",
  },
  pause: {
    default: "ios-theme/icons/pause.svg",
  },
  menu: {
...
export const osResources = {
  ...
  pause: icons.pause[OS] ? icons.pause[OS] : icons.pause.default,
  play: icons.play[OS] ? icons.play[OS] : icons.play.default,
  ...
  flowValue: icons.flowValue[OS]
    ? icons.flowValue[OS]
    : icons.flowValue.default,
  ...
  chart: icons.chart[OS] ? icons.chart[OS] : icons.chart.default,
  gpio: icons.ctrlSheet[OS] ? icons.ctrlSheet[OS] : icons.ctrlSheet.default,
  country: icons.country[OS] ? icons.country[OS] : icons.country.default,
  lock: icons.lock[OS] ? icons.lock[OS] : icons.lock.default,
  unlock: icons.unlock[OS] ? icons.unlock[OS] : icons.unlock.default,

...
import { WidgetAreaSingleScreen } from "@/modules/widget/WidgetAreaSingleScreen";
import { useContext } from "react";
import { Navigate, Route, Routes } from "react-router-dom";
import Layout from "../../components/layouts/Layout";
import { AboutScreen } from "../fireback/AboutScreen";
import { WidgetsArchiveScreen } from "@/modules/widget/WidgetsArchiveScreen";
  ...
  return (
    <Routes>
      ...
      <Route path=":locale" element={<Layout sidebarMenu={sidebarMenu} />}>
        <Route
          path={"dashboard/:uniqueId"}
          element={<WidgetAreaSingleScreen />}
        ></Route>
        <Route path={"widgets"} element={<WidgetsArchiveScreen />}></Route>

...
func init() {
	// workspaces.ForcedCapabilities = []*workspaces.CapabilityEntity{
	// 	{UniqueId: "root/gpio/*"},
	// 	{UniqueId: "root/gpiomode/*"},
	// 	{UniqueId: "root/gpiostate/*"},
	// 	{UniqueId: "root/mqttconnection/*"},
	// 	{UniqueId: "root/datanode/*"},
	// 	{UniqueId: "root/controlsheet/*"},
	// }
	...
	workspaces.BundledConfig = &workspaces.AppConfig{
		...
		Database: workspaces.Database{
			Database: "{appDataDirectory}esp-studio-database.db",
			// Database: "/tmp/acd.db",
			Vendor: "sqlite",
		},
	}

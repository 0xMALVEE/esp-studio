...
func BeginOrAttachOperation(query workspaces.QueryDSL, fn BackgroundOptFn) (*BackgroundReactiveProcess, error) {
...
type BackgroundOptFn func(query workspaces.QueryDSL, done chan bool, read chan map[string]interface{}) (chan *string, error)

func BeginOperation(query workspaces.QueryDSL, fn BackgroundOptFn) (*BackgroundReactiveProcess, error) {
	done := make(chan bool)
